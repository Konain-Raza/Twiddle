...
const Hero = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${domain}/crunch`, { url });
      ...
      <div className="grid w-screen items-center h-max px-5 md:px-20 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          >
            ...
            <i class="text-black ri-arrow-right-s-line"></i>
          </a>
          ...
          <div className="flex flex-col sm:flex-row">
            <a
              href="#docs"
              class="overflow-hidden  w-max p-5 h- bg-black text-white border-none rounded-full text-xl font-bold cursor-pointer relative z-10 group"
            >
              Explore API 🔮
              ...
              <span class="absolute w-44 h-48 -top-8 -left-2 bg-blue-600 rotate-12 transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-1000 duration-500 origin-left"></span>
              <span class="group-hover:opacity-100 group-hover:duration-1000 duration-100 opacity-0 absolute top-5 left-14 z-10">
                Explore!
              </span>
            </a>
          </div>
